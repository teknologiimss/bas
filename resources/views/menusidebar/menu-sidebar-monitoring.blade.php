            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card h-100 shadow-sm hover-shadow border-0">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">Lacak status dan jadwal pengiriman barang secara real-time ke tujuan.</p>
                    </div>
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
                        <a href="{{ route('pengiriman.index') }}" class="btn btn-outline-primary btn-block rounded-pill">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card h-100 shadow-sm hover-shadow border-0">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">Pantau kelayakan, penggunaan, dan masa berlaku izin peralatan angkat.</p>
                    </div>
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card h-100 shadow-sm hover-shadow border-0">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">Pengecekan dan verifikasi berkala untuk kondisi sarana serta fasilitas harian.</p>
                    </div>
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
                        <a href="{{ route('fasilitas-harian.index') }}" class="btn btn-outline-info btn-block rounded-pill">
                            Buka Menu <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card h-100 shadow-sm hover-shadow border-0">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">Kelola data induk dan standar parameter perawatan berkala seluruh aset.</p>
                    </div>
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card h-100 shadow-sm hover-shadow border-0">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">Matriks integrasi jadwal dan histori pelaksanaan pemeliharaan aset operasional.</p>
                    </div>
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
                        <a href="{{ route('asset-maintenance.index') }}" class="btn btn-outline-success btn-block rounded-pill">
                            Buka Menu <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card h-100 shadow-sm hover-shadow border-0">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">Formulir inspeksi pencegahan kerusakan mesin dan peralatan secara rutin.</p>
                    </div>
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card h-100 shadow-sm hover-shadow border-0">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">Pantau pengajuan, alur perbaikan, serta penyelesaian Surat Permintaan Perbaikan.</p>
                    </div>
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card h-100 shadow-sm hover-shadow border-0">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">Tracking proses penggulungan ulang dinamo/motor listrik dari penerimaan hingga selesai.</p>
                    </div>
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
...
<style>
    ...
    .bg-warning-soft { background-color: #fef5e7; }
    .bg-info-soft { background-color: #e3f2fd; }
    .bg-secondary-soft { background-color: #f0f1f2; }
    .bg-success-soft { background-color: #e8f5e9; }
    .bg-danger-soft { background-color: #ffebee; }
    .bg-purple-soft { background-color: #f3e5f5; }
    .bg-indigo-soft { background-color: #e8eaf6; }

    .text-purple { color: #8e24aa; }
    .btn-outline-purple { color: #8e24aa; border-color: #8e24aa; }
    .btn-outline-purple:hover { background-color: #8e24aa; color: #fff; }

    .text-indigo { color: #3f51b5; }
    .btn-outline-indigo { color: #3f51b5; border-color: #3f51b5; }
    .btn-outline-indigo:hover { background-color: #3f51b5; color: #fff; }
</style>
@endsection