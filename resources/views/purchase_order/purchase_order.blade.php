            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" id="save" action="{{ route('purchase_order.store') }}" method="post">
                        ...
                        <div class="form-group row">
                            <label for="ttd_vendor" class="col-sm-4 col-form-label">{{ __('Nama Terang Vendor') }}
                            </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="jabatan_vendor" class="col-sm-4 col-form-label">{{ __('Jabatan Vendor') }}
                            </label>
                            <div class="col-sm-8">
                ...
                error: function(xhr) {
                    ...
                    if (xhr.status === 422 && xhr.responseJSON && xhr.responseJSON.errors) {
                        ...
                        toastr.error(xhr.responseJSON?.message ||
                            'Gagal menyimpan detail Purchase Order!');
                    }
                }
            })
        });
