    ...
    <div class="wrapper" style="margin-left: 0">
        <nav class="main-header navbar navbar-expand navbar-white navbar-dark"
            ...
            <ul class="navbar-nav flex-grow-1 justify-content-between align-items-center flex-wrap">
                ...
                <!-- Logo IMSS -->
                <li class="nav-item">
                    <img src="{{ asset('img/logobas.png') }}" class="d-block mx-auto img-fluid" height="55"
                        alt="IMSS Logo"
                        style="object-fit: contain; max-height: 87px;background: white;width: 125px;height: 80px;">
                </li>
                ...
                <div class="d-flex align-items-center flex-wrap justify-content-center">
                    ...
                    <li class="nav-item mx-0">
                        @if (Auth::check())
                            <a href="{{ route('home') }}" class="nav-link text-center">Beranda</a>
                        @endif
                    </li>
                    ...
                    <li class="nav-item mx-1">
                        @if (Auth::check())
                            <span class="nav-link text-center"
                                style="{{ strlen(Auth::user()->name) > 10 ? 'font-size: 15px;' : 'font-size: 16px;' }}">
                                Halo, {{ Auth::user()->name }}!
                            </span>
                        @else
                    ...
                    <li class="nav-item mx-2">
                        @if (Auth::check())
                            ...
                            <a href="javascript:;" onclick="document.getElementById('logout-form').submit();"
                                class="btn btn-light btn-sm text-center">Logout</a>
                        @endif
                    </li>
                </div>
            </ul>
