...
<body>
    ...
    <div class="container">
        ...
        <div class="info-surat">
            <p><span style="font-size: 10px" class="label">Nomor Surat &nbsp;&nbsp;: {{ $nego->nomor_nego }}</span>
            </p>
            <p><span class="label">Lampiran&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                    {{ __($nego->lampiran) > 0 ? $nego->lampiran . ' Lembar' : '-' }}</span></p>
            </p>
        ...
        <div class="content">
            ...
            <p style="text-align: justify; font-size:11px;">
                Menunjuk penawaran harga {{ $neg->nama }} No.<b
                    style="font-size: 11px">{{ $nego->no_jawaban_vendor }}</b> dengan ini kami bermaksud melakukan
            ...
            @foreach ($nego->details->chunk(5) as $chunk)
            <table class="table" align="center">
                <thead>
                    <tr>
                        <th style="text-align: center" rowspan="2">NO</th>
