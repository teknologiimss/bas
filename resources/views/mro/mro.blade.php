...
@section('content')
    ...
    <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-mro"
                        onclick="addMRO()"><i class="fas fa-plus"></i> Add Data Proyek MRO</button>
                        ...
                        <table id="table" class="table table-sm table-bordered table-hover table-striped">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th>No.</th>
                                    <th>{{ __('No. PO / Nota dinas') }}</th>
                                    <th>{{ __('Judul Pekerjaan') }}</th>
                                    <th>{{ __('Jenis Pekerjaan') }}</th>
                                    <th>{{ __('Tanggal Mulai Kontrak') }}</th>
                                    <th>{{ __('Tanggal Selesai kontrak') }}</th>
                                    ...
                                    @foreach ($requests as $key => $d)
                                        @php
                                            $data = [
                                                ...
                                                'po_nodin' => $d->po_nodin,
                                                'judul_pekerjaan' => $d->judul_pekerjaan,
                                                'jenis_pekerjaan' => $d->jenis_pekerjaan,
                                                'tanggal_kontrak' => $d->date('d/m/Y', strtotime($d->tanggal_kontrak)),
                                                'selesai_kontrak' => $d->date('d/m/Y', strtotime($d->selesai_kontrak)),
                                                'customer' => $d->customer,
                                                'status' => $d->status,
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><input type="checkbox" name="hapus[]"
                                                    value="{{ $d->id }}"></td>
                                            <td class="text-center">{{ $data['no'] }}</td>
                                            <td class="text-center">{{ $data['po_nodin'] }}</td>
                                            <td class="text-center">{{ $data['judul_pekerjaan'] }}</td>
                                            <td class="text-center">{{ $data['jenis_pekerjaan'] }}</td>
                                            <td class="text-center">{{ $data['tanggal_kontrak'] }}</td>
                                            <td class="text-center">{{ $data['selesai_kontrak'] }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button title="Edit Mro" type="button" class="btn btn-success btn-xs"
                                                    data-toggle="modal" data-target="#add-mro"
                                                    onclick="editMRO({{ json_encode($data) }})"
                                                    @if ($data['editable'] == 0) disabled @endif>
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button title="Detail MRO" type="button" data-toggle="modal"
                                                    data-target="#detail-mro" class="btn-lihat btn btn-info btn-xs"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 id="modal-title" class="modal-title">{{ __('Add MRO') }}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form role="form" id="save" action="{{ route('products.mro.store') }}"
                            method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="po_nodin" class="col-sm-4 col-form-label">{{ __('PO / Nota Dinas') }}
                                </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="po_nodin" name="po_nodin"
                                        autocomplete="off">
                                </div>
                            </div>
                            ...
                            {{-- Judul Pekerjaan --}}
                            <div class="form-group row">
                                <label for="judul_pekerjaan" class="col-sm-4 col-form-label">{{ __('Judul Pekerjaan') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            {{-- Jenis Pekerjaan --}}
                            <div class="form-group row">
                                <label for="jenis_pekerjaan" class="col-sm-4 col-form-label">{{ __('Jenis Pekerjaan') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            {{-- Tanggal Kontrak --}}
                            <div class="form-group row">
                                <label for="tanggal_kontrak" class="col-sm-4 col-form-label">{{ __('Tanggal Kontrak') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="selesai_kontrak" class="col-sm-4 col-form-label">{{ __('Selesai Kontrak') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            {{-- Customer --}}
                            <div class="form-group row">
                                <label for="customer" class="col-sm-4 col-form-label">{{ __('Customer') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            {{-- Keterangan --}}
                            <div class="form-group row">
                                <label for="keterangan" class="col-sm-4 col-form-label">{{ __('Keterangan') }}
                                </label>
                                <div class="col-sm-8">
        ...
        {{-- modal lihat detail --}}
        <div class="modal fade" id="detail-mro">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 id="modal-title" class="modal-title">{{ __('Detail MRO') }}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12" id="container-form">
                                    ...
                                    <table class="align-top w-100">
                                        <tr>
                                            <td style="width: 3%;"><b>PO / Nota Dinas</b></td>
                                            <td style="width:2%">:</td>
                                            <td style="width: 55%"><span id="po_nodin"></span></td>
                                        </tr>
                                        {{-- <tr>
...
@section('custom-js')
    ...
    <script>
        ...
        $('#detail-mro').on('hidden.bs.modal', function() {
        ...
        function showAddProduct() {
            if ($('#detail-mro').find('#container-product').hasClass('d-none')) {
                $('#detail-mro').find('#container-product').removeClass('d-none');
                $('#detail-mro').find('#container-product').addClass('col-5');
                $('#detail-mro').find('#container-form').removeClass('col-12');
                $('#detail-mro').find('#container-form').addClass('col-7');
                $('#button-tambah-produk').text('Kembali');
                $('#button-update-mro').off('click');
                // Menambahkan event listener baru untuk menghandle klik pada tombol
                $('#button-update-mro').text("Simpan").on('click', function() {
                ...
                $('#detail-mro').find('#container-product').removeClass('col-5');
                $('#detail-mro').find('#container-product').addClass('d-none');
                $('#detail-mro').find('#container-form').addClass('col-12');
                $('#detail-mro').find('#container-form').removeClass('col-7');
        ...
        function editMRO(data) {
            $('#modal-title').text("Edit MRO");
            $('#button-save').text("Simpan");
            resetForm();
            $('#save_id').val(data.id);
            $('#po_nodin').val(data.po_nodin);
            $('#judul_pekerjaan').val(data.judul_pekerjaan);
            ...
            $('#tanggal_kontrak').val(newDate);
            $('#selesai_kontrak').val(newDate);
        ...
        $('#detail-mro').on('show.bs.modal', function(event) {
