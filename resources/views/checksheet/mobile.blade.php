...
@section('content')
    ...
    <style>
        ...
        .scroll-top-btn {
            ...
            align-items: center;
            justify-content: center;
            box-shadow: 0 5px 15px rgba(179, 0, 0, .25);
            cursor: pointer;
            z-index: 999;
    ...
    <div class="mobile-container py-3">
        ...
        <div class="header-card">
            ...
            <div class="d-flex justify-content-between align-items-start gap-2">
                ...
                {{-- BUTTON KEMBALI --}}
                <a href="{{ route('checksheet.index') }}" class="btn-back">
                                            ...
                                            <div class="detail-box">
                                                ...
                                                <div class="radio-wrapper">
                                                    ...
                                                    <label class="w-100">
                                                        ...
                                                        <input type="radio" name="details[{{ $detail->id }}][status]"
                                                            value="OK"
    ...
    {{-- BUTTON SCROLL TOP --}}
    <button type="button" class="scroll-top-btn" id="scrollTopBtn">
