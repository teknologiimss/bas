                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    {{-- ISI CHECKSHEET --}}
                                    <a href="{{ route('checksheet.mobile', $d->id) }}"
                                        class="btn-mobile-modern">
                                    ...
                                    {{-- DETAIL --}}
                                    <a href="{{ route('checksheet.show', $d->id) }}"
                                    ...
                                    {{-- EDIT --}}
                                    <a href="{{ route('checksheet.edit', $d->id) }}"
                                    ...
                                    {{-- DELETE --}}
                                    <form action="{{ route('checksheet.destroy', $d->id) }}"
                                        method="POST">
                                        ...
                                        <button type="submit"
                                            onclick="return confirm('Hapus checksheet ini?')"
