    ...
    <div class="container">
        ...
        @foreach ($lois as $lo)
            ...
            <div class="content">
                ...
                @foreach ($loi->details->chunk(5) as $chunk)
                            ...
                            @foreach ($chunk as $item)
                                @php
                                    ...
                                    $harga_per_unit_imss = is_numeric($item->harga_per_unit_imss)
                                        ...
                                        : 0;
                                    $loi_qty = is_numeric($item->loi_qty) ? $item->loi_qty : 0;

                                    $total = $loi_qty * $harga_per_unit;
                                    $total_imss = $loi_qty * $harga_per_unit_imss;
            ...
            <div style="margin-left: 70%; width: 50%; margin-top: 5%; page-break-inside: avoid;">
            <table class="w-100">

                <tr>
                    <td class="text-center" style="text-align: center">
                        <b style="font-size: 12px">PT. INKA MULTI SOLUSI SERVICE</b>
                            ...
                            @if ($total_negosiasi < 25000000)
                                ...
                                @elseif($total_negosiasi >= 25000000 && $total_negosiasi < 100000000)
                                    ...
                                    @elseif($total_negosiasi >= 100000000 && $total_negosiasi < 1000000000)
                                        </b><br><b style="font-size: 10px">DIREKTUR UTAMA</b>
                                        @endif
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: center; vertical-align: bottom">
                        <b style="text-decoration: underline;">
                            @if ($total_negosiasi < 25000000)
                                ...
                                @elseif($total_negosiasi>= 25000000 && $total_negosiasi < 100000000)
                                    RAHARDIAN TITUS N.
                                    @elseif($total_negosiasi>= 100000000 && $total_negosiasi < 10000000000000)
                                        CHANDRA AGUNG SASONO
                                        @endif
                                        </td>
                </tr>
            </table>
