                                    ...
                                    <div class="col-lg-4 col-6">
                                        <a href="{{ route('spph_rfq.index') }}">
                                            <div class="small-box"
                                                ...
                                                <!-- Gambar sebagai background -->
                                                <div style="position: relative;">
                                                    <img src="public/img/rfq.png" class="d-block w-100 img-fluid"
                                                        height="200" width="400" alt="pr"
                                                        style="object-fit: cover;">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-6">
                                        <a href="{{ route('loiluar.index') }}">
                                            <div class="small-box"
                                                ...
                                                <!-- Gambar sebagai background -->
                                                <div style="position: relative;">
                                                    <img src="public/img/loiluar.png" class="d-block w-100 img-fluid"
                                                        height="200" width="400" alt="pr"
                                                        style="object-fit: cover;">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-6">
                                        <a href="{{ route('negoluar.index') }}">
                                            <div class="small-box"
                                                ...
                                                <!-- Gambar sebagai background -->
                                                <div style="position: relative;">
                                                    <img src="public/img/negoluar.png" class="d-block w-100 img-fluid"
                                                        height="200" width="400" alt="pr"
                                                        style="object-fit: cover;">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-6">
                                        <a href="{{ route('purchase_orderluar.index') }}">
                                            <div class="small-box"
                                                ...
                                                <!-- Gambar sebagai background -->
                                                <div style="position: relative;">
                                                    <img src="public/img/poluar.png" class="d-block w-100 img-fluid"
                                                        height="200" width="400" alt="po"
                                                        style="object-fit: cover;">
                                                </div>
                                            </div>
