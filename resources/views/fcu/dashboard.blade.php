    ...
    <div class="container py-4">
        ...
        <div class="top-card d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                <div class="h3 fw-bold mb-1 d-flex align-items-center gap-2">
                    <i class="fa-solid fa-chart-line fs-4"></i> Dashboard Monitoring FCU
                </div>
                <p class="mb-0 text-white-50">Ringkasan statistik dan kondisi perawatan unit Fan Coil Unit</p>
            </div>
            <div>
                <a href="{{ route('fcu.index') }}" class="btn btn-light btn-modern shadow-sm">
            ...
            <div class="col-xl col-sm-6">
                <div class="kpi-card d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="fw-bold text-warning mb-0 mt-1">{{ $totalSoCatatan ?? 0 }}</h2>
                    </div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-lg-7">
                <div class="chart-card">
                    <div class="card-title-custom">
                        <i class="fa-solid fa-chart-column"></i> Jenis Perawatan FCU
                    </div>
                    <div class="chart-container">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-secondary px-3 py-2">
                                        {{ $item->jenis_perawatan === 'Unscheduled' ? $item->unscheduledForm->no_fcu ?? $item->no_fcu : $item->no_fcu }}
                                    </span>
                                </td>
