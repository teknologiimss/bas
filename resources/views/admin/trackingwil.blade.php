...
@section('custom-css')
    ...
    <style>
        ...
        .form-control:focus {
            box-shadow: 0 0 0 .18rem rgba(11, 61, 145, .25);
                            ...
                            <td class="text-center">
                                @endif --}}
                                            ...
                                            @if (Auth::user()->role == 2 && strpos(strtolower($data['no_pr']), 'wil1') !== false)
                                                ...
                                                <td class="text-center">{{ $data['dasar_pr'] }}</td>
                                                <td class="text-center">
                                                @elseif (in_array(Auth::user()->role, [0, 1, 7]))
                                                <td class="text-center">{{ $data['no_pr'] }}</td>
                                                <td class="text-center">{{ $data['proyek'] }}</td>
                                                <td class="text-center">{{ $data['tanggal'] }}</td>
                                                <td class="text-center">{{ $data['dasar_pr'] }}</td>
                    ...
                    if (data.pr.details.length == 0) {
                        ...
                        $.each(data.pr.details, function(key, value) {
                            ...
                            if (!value.id_spph && !value.id_loi && !value.id_po && !value
                                ...
                                status =
                                    'Sedang Proses NEGOTIATION LETTER (Melalui LOI Luar Negeri)';
                            ...
                            $('#table-pr').append('<tr><td>' + (key + 1) + '</td><td>' + value
                                .kode_material + '</td><td>' + value.uraian + '</td><td>' +
                                value.spek + '</td><td>' + value.qty + '</td><td>' +
                                value.satuan + '</td><td>' + value.waktu +
                                '</td><td style="color:' +
                                value.backgroundcolor + '">' + value.countdown + '</td>' +
                                '<td><b>' + status + '</b><br><br><b>' + msg + date + '</b></td>' +
