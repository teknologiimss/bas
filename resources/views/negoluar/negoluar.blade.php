    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-NEGO"
                        onclick="addNEGO()"><i class="fas fa-plus"></i> Add New NEGOTIATION LETTER</button>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table id="table" class="table table-sm table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                @if (count($negoluares) > 0)
                                    @foreach ($negoluares as $key => $d)
                                        @php
                                            // $penerima = $d->penerima;
                                            ...
                                            $vendor = $d->vendor;
                                            $data = [
                                                'no' => $negoluares->firstItem() + $key,
                                                'nomor_negoluar' => $d->nomor_negoluar,
                                                'id_pr' => $d->id_pr,
                                                'nomor_pr' => $d->nomor_pr,
                                                'lampiran' => $d->lampiran,
                                                ...
                                                'vendor' => $vendor,
                                                'perihal' => $d->perihal,
                                                'tanggal' => date('d/m/Y', strtotime($d->tanggal_negoluar)),
                                                'batas' => date('d/m/Y', strtotime($d->batas_negoluar)),
                                                'penerima' => $d->penerima,
                                                'alamat' => $d->alamat,
                                                'no_jawaban_vendor' => $d->no_jawaban_vendor,
                                                'franco' => $d->franco,
                                                'keterangan_negoluar' => $d->keterangan_negoluar,
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $data['nomor_negoluar'] }}</td>
            ...
            <div class="mt-3 d-flex justify-content-end">
                {{ $negoluares->links('pagination::bootstrap-4') }}
            </div>
        </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" id="save" action="{{ route('negoluar.store') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="nomor_negoluar"
                                            class="col-sm-4 col-form-label">{{ __('Nomor Nego') }}</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="nomor_negoluar"
                                                name="nomor_negoluar">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="tanggal_negoluar"
                                            class="col-sm-4 col-form-label">{{ __('Date Nego') }}</label>
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control" id="tanggal_negoluar"
                                                name="tanggal_negoluar">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="batas_negoluar"
                                            class="col-sm-4 col-form-label">{{ __('Quot. Deadline') }}</label>
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control" id="batas_negoluar"
                                                name="batas_negoluar">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="no_jawaban_vendor"
                                            class="col-sm-4 col-form-label">{{ __('Vendor Answer Number') }}</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row">
                                        <label for="keterangan_negoluar"
                                            class="col-sm-4 col-form-label">{{ __('Information') }}</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" id="keterangan_negoluar" name="keterangan_negoluar" rows="4"
        ...
        <div class="modal fade" id="detail-nego">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <form id="cetak-nego" method="GET" action="{{ route('negoluar.print') }}"
                                target="_blank">
                                <input type="hidden" name="negoluar_id" id="negoluar_id">
                                        ...
                                        <table class="table table-bordered" style="text-align: center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>QTY</th>
                                                    <th>Satuan</th>
                                                    <th>Quotation Unit Price</th>
                                                    <th>Negotiation Unit Price</th>
                                                    <th>Aksi</th>
                                                </tr>
                                                {{-- <tr>
                                                    <th>Harga Satuan Rp.</th>
        ...
        <div class="modal fade" id="delete-nego">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" id="delete" action="{{ route('negoluar.destroy') }}" method="post">
                            @csrf
                            @method('delete')
    ...
    <script>
        ...
        $('#delete-selected').click(function() {
            ...
            if (ids.length > 0) {
                ...
                $.ajax({
                    url: 'negoluar-imss/hapus-multiple',
                    type: 'POST',
                    data: {
                        _token: token,
                        ids: ids
        ...
        function editNEGO(data) {
            ...
            $('#save_id').val(data.id);
            $('#id_pr').val(data.id_pr);
            $('#nomor_negoluar').val(data.nomor_negoluar);
            ...
            $('#no_jawaban_vendor').val(data.no_jawaban_vendor);
            $('#franco').val(data.franco);
            $('#keterangan_negoluar').val(data.keterangan_negoluar);
            ...
            var date = data.tanggal.split('/');
            var newDate = date[2] + '-' + date[1] + '-' + date[0];
            $('#tanggal_negoluar').val(newDate);

            date = data.batas.split('/');
            newDate = date[2] + '-' + date[1] + '-' + date[0];
            $('#batas_negoluar').val(newDate);
        ...
        function getDetailNego(id_pr) {
            ...
            $.ajax({
                url: "{{ url('products/products_pr_negoluar/') }}/" + id_pr,
                type: "GET",
                data: {
                    "format": "json"
                },
                ...
                success: function(data) {
                    ...
                    if (data.products && Array.isArray(data.products)) {
                        $.each(data.products, function(key, value) {
                            ...
                            var checkbox;
                            if (value.qty_negoluar === null || value.qty_negoluar === "" || value
                                .qty_negoluar >= 0) {
                            ...
                            $('#detail-material').append(
                                ...
                                '<td>' + value.uraian + '</td>' +
                                '<td>' + value.spek + '</td>' +
                                '<td data-original-qty="' + value.qty_negoluar + '">' + value
                                .qty_negoluar +
                                ...
                                '<input type="text" class="form-control qty_negoluar1-input" style="width: 50px;" value="' +
                                value.qty_negoluar1 + '" data-qty="' + value.qty_negoluar1 + '">' +
        ...
        function addToDetails() {
            $.ajax({
                url: "{{ url('products/tambah_negoluar_detail') }}",
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "selected_id": selected,
                    "negoluar_id": $('#negoluar_id').val(),
                    "negoluar_id": $('#negoluar_id').val(),
                },
                dataType: "json",
                beforeSend: function() {
                ...
                success: function(data) {
                    loader(0);
                    $('#form').show();
                    var id_pr = data.negoluar.id_pr;
                    getDetailNego(id_pr);
                    console.log(data);
                    if (!data.success) {
                        toastr.error(data?.message || 'Gagal menyimpan data detail negoluar!');
                        return
                    }
                    var no = 1;
                    selected = [];
                    ...
                    $.each(data.negoluar.details, function(key, value) {
                        ...
                        $('#table-nego').append(
                            ...
                            value.id + '" data-id_negoluar="' + id_negoluar +
                    ...
                    setTimeout(function() {
                        toastr.success(data?.message || 'Berhasil menyimpan data detail negoluar!');
                    }, 200);
                },
                error: function(xhr) {
                    toastr.error(xhr.responseJSON?.message || 'Gagal menyimpan data detail negoluar!');
                    $('#pcode').prop("disabled", false);
                    $('#button-check').prop("disabled", false);
                }
            });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data.products, function(key, value) {
                            ...
                            var no_negoluar
                            if (!value.id_negoluar) {
                                no_negoluar = '-'
                            } else {
                                no_negoluar = value.nomor_negoluar
                            }
                            ...
                            var checkbox;
                            if (value.id_spph && !value.id_negoluar) {
                            ...
                            $('#detail-material').append(
                                ...
                                '</td><td>' + value.spek + '</td><td>' + value.negoluar_qty +
                                '</td><td>' +
                                value
        ...
        function lihatSjn(data) {
            ...
            $('#no_surat').text(data.nomor_negoluar);
            $('#nama_penerima').text(data.penerima);
            $('#tgl_nego').text(data.tanggal);
            $('#table-nego').empty();

            $.ajax({
                url: "{{ url('products/negoluar_detail') }}" + "/" + data.id,
                type: "GET",
                dataType: "json",
                beforeSend: function() {
                    $('#table-nego').append('<tr><td colspan="13" class="text-center">Loading...</td></tr>');
                    $('#button-cetak-nego').html('<i class="fas fa-spinner fa-spin"></i> Loading...');
                    $('#button-cetak-nego').attr('disabled', true);
                },
                success: function(response) {
                    $('#no_surat').text(response.negoluar.no_negoluar);
                    $('#nama_penerima').text(response.negoluar.penerima);
                    $('#tgl_negoluar').text(response.negoluar.tanggal_negoluar);
                    $('#negoluar_id').val(response.negoluar.id);
                    $('#button-cetak-nego').html('<i class="fas fa-print"></i> Cetak');
                    $('#button-cetak-nego').attr('disabled', false);

                    if (response.negoluar.details.length === 0) {
                        $('#table-nego').append(
                            '<tr><td colspan="13" class="text-center">Tidak ada produk</td></tr>');
                    } else {
                        $.each(response.negoluar.details, function(key, value) {
                            var negoluar_qty = value.negoluar_qty ||
                                0; // Pastikan nego_qty didefinisikan, jika tidak gunakan 0
                            var id = value.id;
                            var id_negoluar = value.id_negoluar;
        ...
        $(document).on('click', '.btn-save', function() {
            var id = $(this).data('id');
            var id_negoluar = $('#negoluar_id').val(); // Ambil dari input hidden agar tidak null
            var id_detail_negoluar = $(this).data('id_detail_negoluar');
            ...
            $.ajax({
                url: "{{ route('detail_negoluar_save') }}",
                type: "POST",
                data: {
                    id: id,
                    id_negoluar: id_negoluar, // Selalu ambil dari input hidden
                    id_detail_negoluar: id_detail_negoluar,
                ...
                success: function(data) {
                    if (data.negoluar.details.length > 0) {
                        ...
                        $('.harga-per-unit, .harga-per-unit-imss').on('input', function() {
                            var id = $(this).data('id');
                            var negoluar_qty = $(this).data('qty');
                ...
                error: function(xhr) {
                    toastr.error(xhr.responseJSON?.message || 'Gagal menyimpan detail negoluar!');
        ...
        $('#btn-save-then-add').on('click', function() {
            ...
            $('#detail-material tr').each(function() { // Loop semua baris
                var $row = $(this);
                var id = $row.data('id');
                var qty_negoluar1 = $row.find('.qty_negoluar1-input').val();
                var isChecked = $row.find('.row-checkbox').prop('checked'); // Cek checkbox

                if (isChecked) {
                    selectedRows++; // Hitung jumlah yang dicentang
                    if (qty_negoluar1 !== '' && !isNaN(qty_negoluar1)) { // Pastikan qty2 valid
                        dataToSend.push({
                            id: id,
                            qty_negoluar1: qty_negoluar1,
                            negoluar_id: $('#negoluar_id').val()
                        });
                    }
                }
            ...
            // });
            $.ajax({
                url: "{{ route('qty_negoluar_save') }}", // Sesuaikan dengan route
                type: "POST",
                data: {
                    data: dataToSend,
                    _token: '{{ csrf_token() }}'
        ...
        $(document).on('input', '.qty_negoluar1-input', function() {
            var $row = $(this).closest('tr');
            var qtyNegoluarCell = $row.find('td:eq(4)');
            var initialQtyNegoluar = parseFloat(qtyNegoluarCell.data('original-qty')) || 0;
            var inputQty_negoluar1 = parseFloat($(this).val()) || 0;

            if (inputQty_negoluar1 > initialQtyNegoluar) {
                alert("Qty2 tidak boleh lebih besar dari Qty SPPH!");
                $(this).val(initialQtyNegoluar);
                inputQty_negoluar1 = initialQtyNegoluar;
            }

            var newQtyNegoluar = initialQtyNegoluar - inputQty_negoluar1;

            qtyNegoluarCell.text(newQtyNegoluar);
        });
        ...
        $(document).on('click', '.btn-delete', function() {
            var id = $(this).data('id');
            var id_negoluar = $(this).data('id_negoluar');
            var id_detail_pr = $(this).data('id_detail_pr');
            var id_detail_negoluar = $(this).data('id_detail_negoluar'); //ggwp

            $.ajax({
                url: "{{ route('detail_negoluar_delete') }}",
                type: "DELETE",
                data: {
                    id: id,
                    id_negoluar: id_negoluar,
                    id_detail_pr: id_detail_pr,
                    id_detail_negoluar: id_detail_negoluar, //ggwp
                    _token: '{{ csrf_token() }}'
                },
                dataType: "json",
                beforeSend: function() {
                ...
                success: function(data) {
                    if (data.negoluar.details.length > 0) {
                        ...
                        $.each(data.negoluar.details, function(key, value) {
                            ...
                            var id_negoluar = value.id_negoluar;
                            var negoluar_qty = value.negoluar_qty;
                            var id_detail_negoluar = value.id_detail_negoluar; //ggwp
                            ...
                            //     '<button type="button" class="btn btn-danger btn-delete" data-id="' +
                            //     value.id + '" data-id_negoluar="' + value.id_negoluar +
                            //     '" data-id_detail_negoluar="' + id_detail_negoluar + //ggwp
                            //     '" data-id_detail_pr="' + value.id_detail_pr +
                            //     '" style="margin-bottom: 10px;">Hapus</button>' +
                            //     '<button type="button" class="btn btn-success btn-save" data-id="' +
                            //     value.id + '" data-id_negoluar="' + value.id_negoluar +
