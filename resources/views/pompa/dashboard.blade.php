    ...
    <div class="container py-4">
        ...
        <div class="top-card d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                <div class="h3 fw-bold mb-1 d-flex align-items-center gap-2">
                    <i class="fa-solid fa-chart-line fs-4"></i> Dashboard Monitoring Pompa
                </div>
                <p class="mb-0 text-white-50">Ringkasan statistik dan kondisi perawatan unit Pompa</p>
            </div>
            <div>
                <a href="{{ route('pompa.index') }}" class="btn btn-light btn-modern shadow-sm">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-lg-7">
                <div class="chart-card">
                    <div class="card-title-custom">
                        <i class="fa-solid fa-chart-column"></i> Jenis Perawatan Pompa
                    </div>
                    <div class="chart-container">
