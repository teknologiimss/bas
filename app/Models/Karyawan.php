...
class Karyawan extends Model
{
    ...
    // protected $fillable = [
    //     'nip', 'nama', 'tanggal_masuk', 'masa_kerjatahun', 'masa_kerjabulan', 'status_pegawai', 'rekrutmen', 'domisili',
    ...
    protected $fillable = [
        ...
        'status_pegawai',
        'karyawan',
        'sk_pengangkatan_atau_kontrak',
        'tanggal_pengangkatan_atau_akhir_kontrak',
        'jabatan_inka',
        'jabatan_imss',
        'column2',
        'administrasi_atau_teknisi',
        'lokasi_kerja',
        'bagian_atau_proyek',
        'departemen_atau_subproyek',
        'divisi',
        'direktorat',
        'sertifikat',
        'surat_peringatan',
