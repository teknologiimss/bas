...
class KaryawanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'akhir' => 'nullable',
            'pb_1' => 'nullable',
            'nomor_kontrak2' => 'nullable',
            'awal2' => 'nullable',
            'akhir2' => 'nullable',
            'pb_2' => 'nullable',
            'nomor_kontrak3' => 'nullable',
            'awal3' => 'nullable',
            'akhir3' => 'nullable',
            'pb_3' => 'nullable',
        ...
        if (empty($id)) {
            ...
            $data['masa_kerja_tahun'] = $data['masa_kerja_tahun'] ? $data['masa_kerja_tahun'] : $update->masa_kerja_tahun;
            $data['masa_kerja_bulan'] = $data['masa_kerja_bulan'] ? $data['masa_kerja_bulan'] : $update->masa_kerja_bulan;
            $data['status_pegawai'] = $data['status_pegawai'] ? $data['status_pegawai'] : $update->status_pegawai;
            $data['karyawan'] = $data['karyawan'] ? $data['karyawan'] : $update->karyawan;
            ...
            $data['column2'] = $data['column2'] ? $data['column2'] : $update->column2;
            ...
            $data['nomor_whatsapp'] = $data['nomor_whatsapp'] ? $data['nomor_whatsapp'] : $update->nomor_whatsapp;
            $data['nomor_linkaja'] = $data['nomor_linkaja'] ? $data['nomor_linkaja'] : $update->nomor_linkaja;
            ...
            $data['column1'] = $data['column1'] ? $data['column1'] : $update->column1;
            ...
            $data['nomor_kontrak'] = $data['nomor_kontrak'] ? $data['nomor_kontrak'] : $update->nomor_kontrak;
            $data['awal'] = $data['awal'] ? $data['awal'] : $update->awal;
            $data['akhir'] = $data['akhir'] ? $data['akhir'] : $update->akhir;
            $data['pb_1'] = $data['pb_1'] ? $data['pb_1'] : $update->pb_1;
            $data['nomor_kontrak2'] = $data['nomor_kontrak2'] ? $data['nomor_kontrak2'] : $update->nomor_kontrak2;
            $data['awal2'] = $data['awal2'] ? $data['awal2'] : $update->awal2;
            $data['akhir2'] = $data['akhir2'] ? $data['akhir2'] : $update->akhir2;
            $data['pb_2'] = $data['pb_2'] ? $data['pb_2'] : $update->pb_2;
            $data['nomor_kontrak3'] = $data['nomor_kontrak3'] ? $data['nomor_kontrak3'] : $update->nomor_kontrak3;
            $data['awal3'] = $data['awal3'] ? $data['awal3'] : $update->awal3;
            $data['akhir3'] = $data['akhir3'] ? $data['akhir3'] : $update->akhir3;
