...
class LoiController extends Controller
{
    ...
    public function QtyLoiSave(Request $request)
    {
        ...
        $request->validate([
            'data' => 'required|array',
            'data.*.id' => 'required|integer',
            'data.*.qty_loi1' => 'required|numeric|min:0' // Memastikan qty_loi1 minimal 0 agar tetap bisa tersimpan
        ]);
    ...
    public function detailLoiSave(Request $request)
    {
        ...
        $request->validate([
            ...
            'id_detail_loi' => 'required|integer',
        ...
        if (!$loi) {
            return response()->json(['success' => false, 'message' => 'Data Loi tidak ditemukan'], 404);
        }
        ...
        return response()->json([
            'success' => true,
            'message' => 'Berhasil menyimpan detail LOI!',
            'loi' => $loi
        ]);
    }
