...
Route::prefix('products')->group(function () {
    ...
    Route::post('tracking-imss/hapus-multiple', [App\Http\Controllers\PurchaseOrderController::class, 'hapusMultipleTracking'])->name('hapus-multiple');
    Route::get('/nopr/getByIdspo', [App\Http\Controllers\PurchaseOrderluarController::class, 'getByIdspo'])->name('nopr.getByIdspo');
    Route::post('qty_poluar_save', [App\Http\Controllers\PurchaseOrderluarController::class, 'QtyPoluarSave'])->name('qty_poluar_save');

    Route::get('test_pr', [App\Http\Controllers\PurchaseOrderluarController::class, 'test_pr'])->name('test_pr');
    Route::get('products_pr_poluar/{id_pr}', [App\Http\Controllers\PurchaseOrderluarController::class, 'getProductPR'])->name('products_pr_poluar');

    Route::get('purchase_orderluar_detail/{id}', [App\Http\Controllers\PurchaseOrderluarController::class, 'getDetailPoluar'])->name('purchase_orderluar_detail');
    ...
    Route::get('spph_rfq_detail/{id}', [App\Http\Controllers\SpphrfqController::class, 'getDetailSpphrfq'])->name('spph_rfq_detail');
    Route::post('update_spph_rfq_detail', [App\Http\Controllers\SpphrfqController::class, 'updateDetailSpph'])->name('spph_rfq_detail.update');
    Route::get('products_pr_spphrfq/{id_pr}', [App\Http\Controllers\SpphrfqController::class, 'getProductPR'])->name('products_pr_spphrfq');
    // Route::get('products_pr', [App\Http\Controllers\SpphController::class, 'getProductPR'])->name('products_pr');
    Route::post('tambah_spph_rfq_detail', [App\Http\Controllers\SpphrfqController::class, 'tambahSpphDetail'])->name('tambah_spph_rfq_detail');
    Route::post('spph-imss/hapus-multiple', [App\Http\Controllers\SpphrfqController::class, 'hapusMultipleSpph'])->name('hapus-multiple');
    Route::get('selectnopr', [App\Http\Controllers\SpphrfqController::class, 'nopr'])->name('nopr.index');
    Route::delete('/detail-spphrfq-delete', [App\Http\Controllers\SpphrfqController::class, 'destroyDetailSpphrfq'])->name('detail_spph_rfq_delete');
    Route::post('detail_spph_rfq_save', [App\Http\Controllers\SpphrfqController::class, 'detailSpphSaverfq'])->name('detail_spph_rfq_save');
    ...
    Route::post('update_negoluar_detail', [App\Http\Controllers\NegoluarController::class, 'updateDetailNegoluar'])->name('negoluar_detail.update');
    Route::get('products_pr_negoluar/{id_pr}', [App\Http\Controllers\NegoluarController::class, 'getProductPR'])->name('products_pr_negoluar');
    Route::post('tambah_negoluar_detail', [App\Http\Controllers\NegoluarController::class, 'tambahNegoluarDetail'])->name('tambah_negoluar_detail');
    Route::post('negoluar-imss/hapus-multiple', [App\Http\Controllers\NegoluarController::class, 'hapusMultipleNegoluar'])->name('hapus-multiple');
    Route::get('selectnopr', [App\Http\Controllers\NegoluarController::class, 'nopr'])->name('nopr.index');
    Route::get('negoluar_print', [App\Http\Controllers\NegoluarController::class, 'negoluarPrint'])->name('negoluar.print');
    Route::delete('/detail-negoluar-delete', [App\Http\Controllers\NegoluarController::class, 'destroyDetailNegoluar'])->name('detail_negoluar_delete');
    ...
    Route::post('update_loiluar_detail', [App\Http\Controllers\LoiluarController::class, 'updateDetailLoiluar'])->name('loiluar_detail.update');
    Route::get('products_pr_loiluar/{id_pr}', [App\Http\Controllers\LoiluarController::class, 'getProductPR'])->name('products_pr_loiluar');
    Route::post('tambah_loiluar_detail', [App\Http\Controllers\LoiluarController::class, 'tambahLoiluarDetail'])->name('tambah_loiluar_detail');
    Route::post('loiluar-imss/hapus-multiple', [App\Http\Controllers\LoiluarController::class, 'hapusMultipleLoiluar'])->name('hapus-multiple');
    Route::get('selectnopr', [App\Http\Controllers\LoiluarController::class, 'nopr'])->name('nopr.index');
    Route::get('loiluar_print', [App\Http\Controllers\LoiluarController::class, 'loiluarPrint'])->name('loiluar.print');
    Route::delete('/detail-loiluar-delete', [App\Http\Controllers\LoiluarController::class, 'destroyDetailLoiluar'])->name('detail_loiluar_delete');
    ...
    Route::prefix('pompa')->name('pompa.')->group(function () {
        Route::get('/dashboard', [PompaController::class, 'dashboard'])->name('dashboard');
